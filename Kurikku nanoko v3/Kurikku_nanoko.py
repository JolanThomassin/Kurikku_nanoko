...
class Jeux() :
	...
	def LancerCredit(self):
		...
		self.texteBéta3 = self.CanvaUn.create_text(self.LargeurEcran/2, 473, text= "Mathis Utzinger", font=("OCR A Extended", 45), fill="#FF14E6")
		self.texteBéta3Double = self.CanvaUn.create_text(self.LargeurEcran/2, 470, text= "Mathis Utzinger", font=("OCR A Extended", 45), fill="#FBFF0F")
		self.texteBéta4 = self.CanvaUn.create_text(self.LargeurEcran/2, 523, text= "Chloé Derumier", font=("OCR A Extended", 45), fill="#FF14E6")
		self.texteBéta4Double = self.CanvaUn.create_text(self.LargeurEcran/2, 520, text= "Chloé Derumier", font=("OCR A Extended", 45), fill="#FBFF0F")
	...
	def MenuBoutiqueQuatrième(self):
		...
		self.boutonDeGauche = self.CanvaUn.create_window(self.LargeurEcran/2-250, self.HauteurEcran/2, window=self.boutonDeGauche)
		self.boutonDeDroite = Button(self.EcranDeJeux, image=self.imageSucces, command=None, borderwidth=0)
		self.boutonDeDroite = self.CanvaUn.create_window(self.LargeurEcran/2+250, self.HauteurEcran/2, window=self.boutonDeDroite)
	...
	def pageMillitaire(self) :
		...
		self.imageWaifu = PhotoImage(file="millitaire/waifuMilli.png")
		self.CanvaUn.create_image(self.LargeurEcran/2/2+50, self.HauteurEcran/2+100, image=self.imageWaifu)
		...
		self.deuxièmeBouton = Button(self.EcranDeJeux, text="Gérer équipe", font=("OCR A Extended", 25), bg='white', fg='black', command=None, width=20)
		...
		self.troisièmeBouton = Button(self.EcranDeJeux, text="Acheter", font=("OCR A Extended", 25), bg='white', fg='black', command=None, width=20)
		self.troisièmeBouton = self.CanvaUn.create_window(self.LargeurEcran/2+(self.LargeurEcran/2/2), self.HauteurEcran/2+50, window=self.troisièmeBouton)
	...
	def pageCode(self):
		...
		def récupérationValeur():
			...
			if (code == "Nathan") :
				self.CanvaUn.itemconfigure(self.résultaCode, text="Il est impulsif")
			if (code == "Lucky") :
				self.CanvaUn.itemconfigure(self.résultaCode, text="Il est Coréen")
